...
/*
    ...
    /**/
    this.loadTextureFrameFromGrid(10,  21+15+12,  21,1,  24,32,  504,104, {x:12,y:17}, {x:0,y:0});
...
//  this.loadSequenceForCollection(1,  0,2*4,  12,  600,  0,1, {w:1,h:1});
    ...
    var worldboost = 2;
    for (v in this.collections[3].sequenceSet) {
        for (w in this.collections[3].sequenceSet[v].frameSet) {
            this.collections[3].sequenceSet[v].frameSet[w].scale.w = worldboost;
            this.collections[3].sequenceSet[v].frameSet[w].scale.h = worldboost;
        }
    }
